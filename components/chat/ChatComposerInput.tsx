...
const WaveBar = React.memo(
  ({ anim, index }: { anim: SharedValue<number>; index: number }) => {
...
const WaveVisualization = React.memo(
  ({ waveAnimations }: { waveAnimations: SharedValue<number>[] }) => (
...
type ChatTextInputRowProps = {
  ...
  setSelectedAttachments: React.Dispatch<
    React.SetStateAction<AttachmentDraft[]>
  >;
  startRecording: () => void;
...
export const ChatTextInputRow = React.memo(
  ({
    ...
    const removeAttachmentAtIndex = React.useCallback(
      (index: number) => {
        setSelectedAttachments((current) => {
        ...
        <View style={styles.inputWrapper}>
          ...
          {isTranscribing ? (
            <View style={styles.transcribingContainer}>
              <Text
                style={[styles.transcribingText, dark && { color: "#E0E0E0" }]}
              >
                Transcribing...
              </Text>
            </View>
          ...
          <View style={styles.actionButtons}>
            ...
            <TouchableOpacity
              ...
              disabled={trimmedInput === "" || disabled}
            >
              <Image
                source={
                  dark
