...
const Settings = (_props: Props) => {
  ...
  const _payPro = async (userId: string) => {
    // if (!userId) {
  ...
  const confirmExportPrivateKey = async () => {
    ...
    try {
      ...
      Alert.alert(
        "Error",
        "Failed to export private key. Please try again later.",
      );
    } finally {
      setLoading(false);
    }
    ...
    >
                ...
                <View style={styles.getProContent}>
                  ...
                  >
                    ...
                    <View>
                      ...
                      <Text style={styles.getProDescription}>
                        Unlock all features
                      </Text>
                    </View>
                  </View>
                ...
                <View style={styles.getProContent}>
                  ...
                  >
                    ...
                    <View>
                      ...
                      <Text style={styles.getProDescriptionLight}>
                        Unlock all features
                      </Text>
                    </View>
                  </View>
              ...
              <Image
                source={
                  theme === "dark"
                    ...
                    : require("@/assets/images/icons/user2.png")
                }
          ...
          >
            ...
            >
              <Image
                source={
                  theme === "dark"
                    ? require("@/assets/images/icons/aichat.png")
                    : require("@/assets/images/icons/aichat.png")
                }
                style={{ width: 24, height: 24 }}
              />
          ...
          >
            ...
            >
              <Image
                source={
                  theme === "dark"
                    ? require("@/assets/images/icons/dark/message.png")
                    : require("@/assets/images/icons/message.png")
                }
                style={{ width: 24, height: 24 }}
              />
              <Text
      ...
      <Modal isVisible={privateKeyModalVisible} style={styles.modal}>
        ...
        >
          ...
          >
            Keep this private key secure. Anyone with access to this key will
            have full control over your wallet.
          </Text>
      ...
      <Modal isVisible={confirmModalVisible} style={styles.modal}>
        ...
        >
          ...
          >
            Are you sure you want to export your private key? This key provides
            complete access to your wallet and funds. Only proceed if you are in
            a secure location.
          </Text>
